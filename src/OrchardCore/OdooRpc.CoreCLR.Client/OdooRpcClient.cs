...
namespace OdooRpc.CoreCLR.Client
{
    public class OdooRpcClient : IOdooRpcClient
    {
        ...
        public Task<string> UnpvoTest(UnovoParameters unovohParams)
        {
            var unovoCommand = new UnovoCommand(CreateRpcClient());
            return unovoCommand.ExecuteCount(this.SessionInfo, unovohParams);
        }

        public Task<string> ExecuteIsExist(UnovoParameters unovohParams)
        {
            var unovoCommand = new UnovoCommand(CreateRpcClient());
            return unovoCommand.ExecuteIsExist(this.SessionInfo, unovohParams);
        }
    }
}